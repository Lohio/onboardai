      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        ...
        >
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="text-sm font-semibold text-white/90">
                  {t('adminCont.eliminarBloque')}
                </h2>
                <p className="text-xs text-white/50 mt-1 leading-relaxed">
                  {t('adminCont.eliminar.aviso')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-5 mb-5 px-3 py-2.5 rounded-lg bg-white/[0.03] border border-white/[0.06]">
            <p className="text-xs text-white/40 mb-0.5">{t('adminCont.eliminar.bloqueAEliminar')}</p>
          ...
          <div className="flex items-center justify-end gap-2 px-5 pb-5">
            ...
            >
              ...
              {t('adminCont.eliminar.confirmar')}
            </Button>
          </div>
        </motion.div>
      </div>
